...
const tools = [
    {
        name: 'MoneyScore',
        description: 'Personalized income and aid details',
        href: '/money-score',
        icon: BanknotesIcon
    },
    {
        name: 'CombinedRate',
        description: 'Calculate combined acceptance rates',
        href: '/combined-rate-calculator',
        icon: CalculatorIcon
    },
]
const callsToAction = [
                ...
                <nav className="mx-auto flex max-w-7xl items-center justify-between p-3 lg:px-8" aria-label="Global">
                    ...
                    <div className="hidden pl-12 lg:flex lg:gap-x-12">
                            <Menu as="div" className="relative">
                                <Menu.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6
                                        ...
                                        {/*<div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                                            {callsToAction.map((item) => (
                                                <Link
                                                    ...
                                                    font-semibold leading-6 text-gray-900 hover:bg-gray-100"
                                                >
                                        ...
                                        {({ open }) => (
                                            <>
                                                ...
                                                <Disclosure.Panel className="mt-2 space-y-2">
                                                    {[...tools].map((item) => ( // add back ...callsToAction
                                                        <Disclosure.Button
                                                            key={item.name}
                                                            as="a"
                                                            href={item.href}
